 ...
 */
public class WebAuthnPolicy extends Authentication {

    @Override
    public String getUriFragment() {
        return super.getUriFragment() + "/webauthn-policy";
    }

    @Page
    private WebAuthnPolicyForm form;

    public WebAuthnPolicyForm form() {
        return form;
    }
}
